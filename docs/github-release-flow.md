...
Release-workflowen använder samma deklarativa output-verifierare som CI. Den genererar också fil-listan för `gh release upload` från runtime-targetregistret, så nya runtime-distributioner publiceras utan plattformsspecifika upload-rader i workflowen.
